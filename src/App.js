          ...
          <div className="row s-about__content">
            <div className="column xl-12">
              ...
              <p className="attention-getter">
                ...
                Voluptas explicabo id debitis cupiditate cumque, error quia!
                Debitis cupiditate ipsa nihil labore, earum atque dolor quos
                saepe vero inventore, odit nam deleniti accusantium omnis
                mollitia consequatur harum incidunt! Ex modi aut repudiandae
                doloremque commodi recusandae labore sit. Perspiciatis omnis
                dolor dolores fuga iusto, recusandae animi nisi consequuntur
                exercitationem id maxime earum pariatur voluptas! Porro non quos
                quae tempora fuga quis sequi minus sed sint debitis reiciendis,
                nostrum natus suscipit iusto odio.
              </p>
              <p className="attention-getter">
                ...
                in reprehenderit. Ut enim ad minim
              </p>
          ...
          <div className="row counter-items">
            <div className="column counter-items__item">
              ...
              <p>
                ...
                harum magni quae voluptate error quo repellendus inventore
                laborum ex veniam.
              </p>
            </div>{" "}
        ...
        <footer id="footer" className="s-footer target-section">
          ...
          <div className="row s-footer__content">
            <div className="column xl-6 md-12 s-footer__block s-footer__about">
              <p className="attention-getter">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Voluptas illum quasi facere libero, fugiat laboriosam possimus
                amet consectetur adipisicing elit reprehenderit eveniet tempore
